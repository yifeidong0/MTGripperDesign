...
for i in {1..5}; do
  ...
  csv_file_a="results/paper/panda_new/$i/panda_ga_results_${timestamp}_1_1_fix.csv"
  csv_file_b="results/paper/panda_new/$i/panda_ga_results_${timestamp}_0_1_fix.csv"
