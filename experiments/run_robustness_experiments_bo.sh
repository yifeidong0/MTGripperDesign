...
for i in {1..5}; do
  ...
  csv_file_a="results/paper/dlr/$i/dlr_bo_results_${timestamp}_1_1.csv"
  csv_file_b="results/paper/dlr/$i/dlr_bo_results_${timestamp}_0_1.csv"
  # csv_file_c="results/paper/dlr/$i/dlr_bo_results_${timestamp}_1_0.csv"
  # csv_file_d="results/paper/dlr/$i/dlr_bo_results_${timestamp}_0_0.csv"
