...
for i in {1..4}; do
  ...
  csv_file_a="results/paper/panda/$i/panda_mtbo_results_${timestamp}_1_1_0.3robreward_3initepi_1explorationweight.csv"
  csv_file_b="results/paper/panda/$i/panda_mtbo_results_${timestamp}_0_1_0.3robreward_3initepi_1explorationweight.csv"
  csv_file_c="results/paper/panda/$i/panda_mtbo_results_${timestamp}_1_0_0.3robreward_3initepi_1explorationweight.csv"
  csv_file_d="results/paper/panda/$i/panda_mtbo_results_${timestamp}_0_0_0.3robreward_3initepi_1explorationweight.csv"
